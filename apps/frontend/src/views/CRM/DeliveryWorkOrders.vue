...
const statusOptions = [{ value: 'pending', label: '待處理' }, { value: 'ready', label: '準備送貨' }, { value: 'in_transit', label: '運送中' }, { value: 'delivered', label: '已送達' }];
...
<style scoped>
.delivery-work-orders-page { width: 100%; margin: 0 auto; }
